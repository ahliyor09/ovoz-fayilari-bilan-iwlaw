...
Original file is located at
    https://colab.research.google.com/drive/1ouvbvUiXoERu-KXfYufVmty33-lfZCyB
"""
...
# Example usage
wav_file_path = '/content/sunflower-street-drumloop-85bpm-163900 (1).wav'  # Replace with your WAV file path
...
# Matnni belgilash
text ="Richard is a good footballer.  He also plays tennis and volleyball. (not He plays also tennis)"
# Ovoz yaratish (gTTS - Google Text-to-Speech)
language = 'en'  # Changed to English ('en')
tts = gTTS(text=text, lang=language, slow=False)
...
# Example usage
wav_file_path = '/content/waves-on-the-lake-in-summer-time-in-wav-64379.wav'  # Replace with your WAV file path
generate_spectrogram(wav_file_path)